...
-- CreateIndex
CREATE UNIQUE INDEX "CartItem_cartId_vehicleId_key" ON "CartItem"("cartId", "vehicleId");

-- CreateIndex
CREATE UNIQUE INDEX "WishlistItem_userId_vehicleId_key" ON "WishlistItem"("userId", "vehicleId");
...
-- AddForeignKey
ALTER TABLE "WishlistItem" ADD CONSTRAINT "WishlistItem_vehicleId_fkey" FOREIGN KEY ("vehicleId") REFERENCES "Vehicle"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
